/**
 转自http://blog.jjonline.cn/userInterFace/173.html
 致敬原作者:)
...
function getLunar() {
    ...
    var lunar = calendar.solar2lunar(solarYear, solarMonth, solarDay);
    $('#lunarDate').html("今天是" + lunar.cYear + '年' + lunar.cMonth + '月' + lunar.cDay + '日(' + lunar.astro + ')<br />农历: ' + lunar.IMonthCn + lunar.IDayCn + '  ' + lunar.gzYear + '年' + lunar.gzMonth + '月' + lunar.gzDay + '日(' + lunar.Animal + '年)');
}

$(document).ready(function() {
    getLunar();
    refreshAt(23, 59, 59, getLunar);
});
